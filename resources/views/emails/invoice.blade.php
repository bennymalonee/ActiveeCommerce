            ...
            <table>
                <tr>
                    <td>
                        ...
                        @else
                            <img loading="lazy" src="{{ static_asset('assets/img/logo.png') }}" height="36"
                ...
                <tr>
                    ...
                    <td width="50%" valign="top">
                        ...
                        <table class="small">
                            ...
                            <tr>
                                <td class="gry-color">{{ get_seller_address($order) }}</td>
                            </tr>
                        </table>
                        ...
                        @if($gstin && is_numeric($order->orderDetails->first()->gst_amount ?? null))
                            <table class="small">
                                <tr>
                                    <td class="gry-color"><span class="strong">{{ translate('GSTIN') }}:</span> {{ $gstin }}
                                    </td>
                                </tr>
                            </table>
                            <br>
                    ...
                    <td width="50%" valign="top" class="text-right">
                        ...
                        <table class="small">
                            <tr>
                                <td class="gry-color strong">{{ translate('Order ID') }}: {{ $order->code }}</td>
                            </tr>
                            <tr>
                                <td class="gry-color strong">{{ translate('Order Date') }}:
                                    {{ date('d-m-Y', $order->date) }}</td>
                            </tr>
                        </table>
                        ...
                        <table class="small">
                            <tr>
                                <td class="strong gry-color" style="font-size: 1.1rem;">{{ translate('Bill to') }}:</td>
                            </tr>
                            <tr>
                                <td class="strong">{{ $billing->name }}</td>
                            </tr>
                            <tr>
                                <td class="gry-color">
                            ...
                            @if(!empty($billing->email))
                                <tr>
                                    <td class="gry-color">{{ translate('Email') }}: {{ $billing->email }}</td>
                                </tr>
                            @endif
                            @if(!empty($billing->phone))
                                <tr>
                                    <td class="gry-color">{{ translate('Phone') }}: {{ $billing->phone }}</td>
                                </tr>
                            @endif
                        </table>
                        ...
                        <table class="small">
                            <tr>
                                <td class="strong gry-color" style="font-size: 1.1rem;">{{ translate('Ship to') }}:</td>
                            </tr>
                            <tr>
                                <td class="strong">{{ $shipping->name }}</td>
                            </tr>
                            <tr>
                                <td class="gry-color">
                            ...
                            @if(!empty($shipping->email))
                                <tr>
                                    <td class="gry-color">{{ translate('Email') }}: {{ $shipping->email }}</td>
                                </tr>
                            @endif
                            @if(!empty($shipping->phone))
                                <tr>
                                    <td class="gry-color">{{ translate('Phone') }}: {{ $shipping->phone }}</td>
                                </tr>
                            @endif
                        </table>
                ...
                <tr>
                    ...
                    <td width="50%">
                        <table class="sm-padding small text-right">
                            ...
                            @endif
                            <tr>
                                <th class="text-left strong" style="font-size: 1.05rem;">{{ translate('Grand Total') }}
                                </th>
