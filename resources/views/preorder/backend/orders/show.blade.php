                        ...
                        <div>
                            ...
                            <div class="d-flex">
                                <p class="text-white m-0">
                                    <span
                                        class="fw-800">{{\Carbon\Carbon::parse($order->created_at)->format('d.m.Y')}}</span>
                                    at
                                    <span
                                        class="fw-800">{{\Carbon\Carbon::parse($order->created_at)->format(' h.i A')}}</span>
                                </p>
                                <p class="text-white m-0 pl-3">
                                    {{ translate('Seller') }}
                                    <span
                                        class="fw-800">{{$order->preorder_product->user->shop != null ? $order->preorder_product->user->shop->name : translate('In-house Product')}}</span>
                                </p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" style="gap: 5px;">

                            <a class="btn text-white p-1 border-0" style="background-color: #6C7A8B;"
                                href="{{route('preorder.invoice_preview', $order->id)}}">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p>
                                        @if($order->delivery_status == 2)
                                            <span
                                                class="badge badge-inline badge-success p-2 rounded-3">{{ translate('Delivered')}}</span>
                                        @elseif($order->shipping_status == 2)
                                            <span
                                                class="badge badge-inline badge-info p-2 rounded-3">{{ translate('In Shipping')}}</span>
                                        @elseif($order->final_order_status == 1)
                                            <span
                                                class="badge badge-inline badge-warning p-2 rounded-3">{{ translate('Final Order Requested')}}</span>
                                        @elseif($order->final_order_status == 2)
                                            <span
                                                class="badge badge-inline badge-success p-2 rounded-3">{{ translate('Final Order Accepted')}}</span>
                                        @elseif($order->final_order_status == 3)
                                            <span
                                                class="badge badge-inline badge-danger p-2 rounded-3">{{ translate('Final Order Cancelled')}}</span>
                                        @elseif($order->prepayment_confirm_status == 1)
                                            <span
                                                class="badge badge-inline badge-primary p-2 rounded-3">{{ translate('Prepayment Requested')}}</span>
                                        @elseif($order->prepayment_confirm_status == 2)
                                            <span
                                                class="badge badge-inline badge-dodger-blue p-2 rounded-3">{{ translate('Prepayment Accepted')}}</span>
                                        @elseif($order->prepayment_confirm_status == 3)
                                            <span
                                                class="badge badge-inline badge-dodger-blue p-2 rounded-3">{{ translate('Prepayment Cancelled')}}</span>
                                        @elseif($order->request_preorder_status == 1)
                                            <span
                                                class="badge badge-inline badge-secondary p-2 rounded-3">{{ translate('Preorder Requested')}}</span>
                                        @elseif($order->request_preorder_status == 2)
                                            <span
                                                class="badge badge-inline badge-gray p-2 rounded-3">{{ translate('Preorder Request Accepted')}}</span>
                                        @elseif($order->request_preorder_status == 2)
                                            <span
                                                class="badge badge-inline badge-danger p-2 rounded-3">{{ translate('Preorder Request Cancelled')}}</span>
                                        @endif
                                    </p>
                                    <p>{{ translate('Amount') }}</p>
                                    <p class="m-0 p-0"> {{format_price($order->subtotal)}}</p>
                                    <p class="mb-1 p-0"><span>{{ translate('Prepay') }}</span>
                                        {{format_price($order->prepayment)}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="preorder-border-dashed rounded-2 d-flex justify-content-between p-4">
                                ...
                                <div class="px-4 mt-4 mb-2">
                                    @can('view_customer_preorder_history')
                                        <a href="#">
                                    ...
                                    @can('ban_customer')
                                        <a href="#">
                                            <span
                                                class="mt-2 badge  w-100  p-3 rounded-3 {{$order->user->banned == 1 ? "badge-danger text-white " : " badge-dodger-blue text-blue" }} "
                                                onclick="confirm_ban('{{route('customers.ban', encrypt($order->user->id))}}');">
                                                {{ translate("" . ($order->user->banned == 1 ? 'Reinstate' : 'ban') . " this Customer?") }}
                                            </span>
                                        </a>
                                    @endcan
                                </div>
                        ...
                        <div class="col-6  p-4 d-flex justify-content-between">
                            <div>
                                <img src="{{ uploaded_asset($order->preorder_product->thumbnail) }}"
                                    alt="{{ translate('customer') }}" class="h-100 img-fit lazyload w-120px h-120px"
                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                            </div>
                            <div class="ml-4">
                                <p>{{ translate('Product') }}</p>
                                <p class="break-word fw-700">{{$order->preorder_product->product_name}}</p>
    ...
    <div class="accordion mt-4" id="accordioncCheckoutInfo">
        ...
        <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                ...
                <div class="d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                        <path id="Path_42357" data-name="Path 42357"
                            ...
                            fill="{{preorder_fill_color($order->request_preorder_status)}}" />
                    </svg>
                    <span class="ml-2 fs-19 fw-700">{{ translate('Request Preorder') }}</span>
                </div>
                <p>
                    <span
                        class="mr-4">{{ $order->request_preorder_time != null ? \Carbon\Carbon::parse($order->request_preorder_time)->format('d.m.Y \a\t h.i A') : ''}}</span><i
                        class="las la-angle-down fs-18"></i>
                </p>
            </div>
            ...
            <div id="collapsePreorderRequest" class="collapse show" aria-labelledby="headingRequestPreorder"
                ...
                <form action="{{route('preorder-order.status_update', $order->id)}}" method="POST"
                    id="preorder_request_form">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row p-4">
                                ...
                                @if(in_array($requestPreorderStatus, [2, 3]))
                                    <div class="col-md-12 col-sm-12 mt-1">
                                        <button type="button"
                                            class="btn btn-block fs-16 {{ $requestPreorderStatus == 2 ? 'btn-success' : 'btn-danger' }}"
                                            disabled>
                                            @if($requestPreorderStatus == 2) <i class="las la-check-circle"></i> @endif
                                            {{  $requestPreorderStatus == 2 ? translate(' Accepted') : translate('Rejected')  }}
                                        </button>
                                    </div>
                                @elseif($requestPreorderStatus == 1 && auth()->user()->can('update_preorder_status'))
                                    <div class="col-md-3 col-sm-12 mt-1">
                                        <button type="button" class="btn btn-block btn-danger text-white "
                                            onclick="preorderConfirmation(3, this, 'Preorder Request')">{{ translate('Reject')}}</button>
                                    </div>
                                    <div class="col-md-9 col-sm-12 mt-1">
                                        <button type="button" class="btn btn-block btn-soft-primary "
                                            onclick="preorderConfirmation(2, this, 'Preorder Request')">{{  translate('Accept') }}</button>
                                    </div>
                                @else
                                    <div class="col-md-3 col-sm-12 mt-1">
                                        <button type="button" class="btn btn-block btn-danger text-white "
                                            disabled>{{ translate('Reject')}}</button>
                                    </div>
                                    <div class="col-md-9 col-sm-12 mt-1">
                                        <button type="button" class="btn btn-block btn-secondary "
                                            disabled>{{  translate('Accept')  }}</button>
                                    </div>
                                @endif
                            </div>
                        @endif
                ...
                <div class="d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                        <path id="Path_42357" data-name="Path 42357"
                            d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                            transform="translate(-48 -48)"
                            fill="{{ preorder_fill_color($order->prepayment_confirm_status) }}" />
                    </svg>
                    <span class="ml-2 fs-19 fw-700">{{ translate('Prepayment Request') }}</span>
                </div>
                <p>
                    <span
                        class="mr-4">{{ $order->prepayment_confirmation_time != null ? \Carbon\Carbon::parse($order->prepayment_confirmation_time)->format('d.m.Y \a\t h.i A') : ''}}</span><i
                        class="las la-angle-down fs-18"></i>
                </p>
            </div>
                            ...
                            <div class="row preorder-border-dashed p-4 m-4">
                                <div class="col d-flex justify-content-between">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p> <img class="w-50px h-50px" src="{{ uploaded_asset($order->payment_proof) }}"
                                                alt=""> </p>
                                ...
                                <div class="col-12">
                                    @if($order->prepayment_confirm_status == 1)
                                        <div class="form-group ">
                                            <label class="col-form-label" for="signinSrEmail">{{translate('Note')}}<span
                                                    class="ml-2">{{translate(('(Upto 200
                                                                                    character)'))}}</span></label>

                                            <textarea name="prepayment_note" rows="4" class="form-control"></textarea>
                                        </div>
                                    @endif
                                    @if($order->prepayment_note)
                                        <p class="border p-2" style="font-style: italic;">
                                ...
                                <div class="row px-4">
                                    @if($order->prepayment_confirm_status == 2)
                                        <div class="col-md-12 col-sm-12 mt-3">
                                            <button type="button" class="btn btn-block btn-success fs-16" disabled><i
                                                    class="las la-check-circle"></i>
                                                {{ translate(' Accepted')  }}</button>
                                        </div>
                                    @elseif($order->prepayment_confirm_status == 3)
                                        <div class="col-md-12 col-sm-12 mt-3">
                                            <button type="button" class="btn btn-block btn-danger"
                                                disabled>{{ translate('Rejected') }}</button>
                                        </div>
                                    @elseif($order->prepayment_confirm_status == 1 && $order->request_preorder_status == 2 && auth()->user()->can('update_preorder_status'))
                                        <div class="col-md-3 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-danger text-white"
                                                onclick="preorderConfirmation(3, this, 'Prepayment Request')">{{ translate('Reject')}}</button>
                                        </div>
                                        <div class="col-md-9 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-soft-primary"
                                                onclick="preorderConfirmation(2, this, 'Prepayment Request')">{{  translate('Accept') }}</button>
                                        </div>
    ...
    @endif
            ...
            <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingFinalPreorder" type="button"
                    ...
                    <p>
                        <span
                            class="mr-4">{{ $order->final_order_time != null ? \Carbon\Carbon::parse($order->final_order_time)->format('d.m.Y \a\t h.i A') : '' }}</span><i
                            class="las la-angle-down fs-18"></i>
                    </p>
                </div>
                                ...
                                <div class="row preorder-border-dashed p-4 m-4">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            @else
                                                <p> <img class="w-50px h-50px"
                                                        src="{{ uploaded_asset($order->final_payment_proof) }}" alt="">
                                                </p>
                                    ...
                                    <div class="col-12">
                                        @if($order->final_order_status == 1)
                                            ...
                                            <div class="form-group ">
                                                <label class="col-form-label" for="signinSrEmail">{{translate('Note')}}</label>

                                                <textarea name="final_oder_note" rows="4" class="form-control"></textarea>
                                            </div>
                                ...
                                @if($order->product_owner == 'admin')
                                    <div class="row px-4">
                                        ...
                                        @elseif($order->final_order_status == 1 && ($order->prepayment_confirm_status == 2) && auth()->user()->can('update_preorder_status'))
                                            <div class="col-md-3 col-sm-12 mt-1">
                                                <button type="button" class="btn btn-block btn-danger text-white "
                                                    onclick="preorderConfirmation(3, this, 'Final Order Request')">{{ translate('Reject')}}</button>
                                            </div>
                                            <div class="col-md-9 col-sm-12 mt-1">
                                                <button type="button" class="btn btn-block btn-soft-primary"
                                                    onclick="preorderConfirmation(2, this, 'Final Order Request')">{{  translate('Accept') }}</button>
                                            </div>
            ...
            <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingInShipping" type="button"
                    ...
                    <p>
                        <span
                            class="mr-4">{{  $order->shipping_time != null ? \Carbon\Carbon::parse($order->shipping_time)->format('d.m.Y \a\t h.i A') : '' }}</span><i
                            class="las la-angle-down fs-18"></i>
                    </p>
                </div>
                ...
                <div id="collapseInShipping" class="collapse " aria-labelledby="headingInShipping"
                    ...
                    <div class="card-body" id="shipping_info">
                        <form action="{{route('preorder-order.status_update', $order->id)}}" method="POST"
                            ...
                            <div class="row preorder-border-dashed p-4 m-4 d-flex ">
                                <div class="col-12">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            @if(!in_array($order->shipping_status, [2, 3]))
                                                ...
                                                <div class="form-control file-amount">{{ translate('Choose
                                                                                    File') }}</div>
                                            @endif
                                            <input type="hidden" name="shipping_proof" class="selected-files"
                                                value="{{$order->shipping_proof}}">
                                        </div>
                                ...
                                <div class="col-12">
                                    @if(!in_array($order->shipping_status, [2, 3]))
                                        <div class="form-group ">
                                            ...
                                            <textarea name="shipping_note" rows="4" class="form-control"></textarea>
                                        </div>
                                    @endif
                                ...
                                <div class="row px-4">
                                    ...
                                    @if($order->shipping_status == 2)
                                        <div class="col-md-12 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-success fs-16" disabled><i
                                                    class="las la-check-circle"></i>
                                                {{ translate(' Marked as shipping')  }}</button>
                                        </div>
                                    @elseif($order->shipping_status == 3)
                                        <div class="col-md-12 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-danger"
                                                disabled>{{  translate('Cancelled') }}</button>
                                        </div>
                                    @elseif($order->shipping_status == 0 && ($order->final_order_status == 2) && auth()->user()->can('update_preorder_status'))
                                        <div class="col-md-3 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-danger text-white "
                                                onclick="preorderConfirmation(3, this, 'Shipping')">{{ translate('Cancel')}}</button>
                                        </div>
                                        <div class="col-md-9 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-block btn-soft-primary"
                                                onclick="preorderConfirmation(2, this, 'Shipping')">{{  translate('Mark as shipping') }}</button>
                                        </div>
            ...
            <!-- Delivery -->
            <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingDelivery" type="button" data-toggle="collapse"
                    data-target="#collapseDelivery" aria-expanded="true" aria-controls="collapseDelivery">
                    <div class="d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                            <path id="Path_42357" data-name="Path 42357"
                                d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                    ...
                    <p>
                        <span
                            class="mr-4">{{ $order->delivery_time != null ? \Carbon\Carbon::parse($order->delivery_time)->format('d.m.Y \a\t h.i A') : '' }}</span><i
                            class="las la-angle-down fs-18"></i>
                    </p>
                </div>
                            ...
                            <div class="">
                                ...
                                <div class="col-12 px-4">
                                    @if(!in_array($order->delivery_status, [2, 3]))
                                        <div class="form-group ">
                                            ...
                                            <textarea name="delivery_note" rows="4" class="form-control"></textarea>
                                        </div>
                                    @endif
                                ...
                                @if($order->product_owner == 'admin')
                                    <div class="row px-4">
                                        ...
                                        @elseif($order->shipping_status == 2)
                                            @can('update_preorder_status')
                                                <div class="col-md-3 col-sm-12 mt-1">
                                                    <button type="button" class="btn btn-block btn-danger text-white"
                                                        onclick="preorderConfirmation(3, this, 'Delivery')">{{ translate('Cancel')}}</button>
                                                </div>
                                                <div class="col-md-9 col-sm-12 mt-1">
                                                    <button type="button" class="btn btn-block btn-secondary"
                                                        onclick="preorderConfirmation(2, this, 'Delivery')">{{ translate('Mark as deliver') }}</button>
                                                </div>
                                            @endcan
                                        @endif
                                    </div>
            ...
            @if($order->preorder_product->is_refundable && $order->delivery_status == 2)
                <!-- Refund -->
                <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                    <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingRefund" type="button" data-toggle="collapse"
                        data-target="#collapseRefund" aria-expanded="true" aria-controls="collapseRefund">
                        <div class="d-flex align-items-center">
                            <div class="rounded-circle d-flex justify-content-center align-items-center"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="2" height="10" viewBox="0 0 2 10">
                                    <g id="Group_38901" data-name="Group 38901" transform="translate(-315 -540)">
                                        <rect id="Rectangle_23991" data-name="Rectangle 23991" width="2" height="7" rx="1"
                                            transform="translate(315 540)" fill="#fff" />
                                        <rect id="Rectangle_23992" data-name="Rectangle 23992" width="2" height="2" rx="1"
                                            transform="translate(315 548)" fill="#fff" />
                                    </g>
                                </svg>
                        ...
                        <p>
                            <span
                                class="mr-4">{{ $order->refund_time != null ? \Carbon\Carbon::parse($order->refund_time)->format('d.m.Y \a\t h.i A') : '' }}</span><i
                                class="las la-angle-down fs-18"></i>
                        </p>
                    </div>
                                ...
                                <div class="">
                                    <div class="row preorder-border-dashed p-4 m-4">
                                        <div class="col d-flex justify-content-between">
                                            ...
                                            <div class="ml-4">
                                                <p> <img class="w-50px h-50px" src="{{ uploaded_asset($order->refund_proof) }}"
                                                        alt=""> </p>
                                    ...
                                    <div class="col-12 px-4">
                                        @if(!in_array($order->refund_status, [2, 3]))
                                            <div class="form-group ">
                                                ...
                                                <textarea name="seller_refund_note" rows="4" class="form-control"></textarea>
                                            </div>
                                        @endif
                                    ...
                                    @if($order->product_owner == 'admin')
                                        <div class="row  px-4">
                                            ...
                                            @elseif($order->refund_status == 1 && ($order->delivery_status == 2) && auth()->user()->can('update_preorder_status'))
                                                <div class="col-md-3 col-sm-12 mt-1">
                                                    <button type="button" class="btn btn-block btn-danger text-white"
                                                        onclick="preorderConfirmation(3, this, 'Refund Request')">{{ translate('Reject')}}</button>
                                                </div>
                                                <div class="col-md-9 col-sm-12 mt-1">
                                                    <button type="button" class="btn btn-block btn-soft-primary"
                                                        onclick="preorderConfirmation(2, this, 'Refund Request')">{{  translate('Accept') }}</button>
                                                </div>
                ...
                <div class=" border p-4 mt-4">
                    ...
                    <div class="order-summary">
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->request_preorder_status !== 0 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                                <span>{{translate('Requested Pre order')}}</span>
                                <span
                                    class="opacity-60">{{ $order->request_preorder_time != null ? \Carbon\Carbon::parse($order->request_preorder_time)->format('H:i \h\r\s, j F, Y') : ''}}</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->request_preorder_status == 2 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                        ...
                        @if($order->preorder_product?->is_prepayment)
                            <div class="d-flex align-items-center mb-4 p-0">
                                <div>
                                    <i
                                        class="las {{ $order->prepayment_confirm_status !== 0 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                                </div>
                                <div class="d-flex flex-column ml-4">
                                    <span>{{translate('Prepayment confirmation')}}</span>
                                    <span
                                        class="opacity-60">{{$order->prepayment_confirmation_time != null ? \Carbon\Carbon::parse($order->prepayment_confirmation_time)->format('H:i \h\r\s, j F, Y') : ''}}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->prepayment_confirm_status == 2 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ (($order->preorder_product->available_date != null && (strtotime($order->preorder_product->available_date) < strtotime(date('d-m-Y')))) || $order->preorder_product->is_available) ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }}"></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->final_order_status == 2 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                                <span>{{translate('Final order ')}}</span>
                                <span
                                    class="opacity-60">{{$order->final_order_time != null ? \Carbon\Carbon::parse($order->final_order_time)->format('H:i \h\r\s, j F, Y') : ''}}</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->shipping_status == 2 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                                <span>{{translate('Product In Shipping')}}</span>
                                <span
                                    class="opacity-60">{{$order->shipping_time != null ? \Carbon\Carbon::parse($order->shipping_time)->format('H:i \h\r\s, j F, Y') : ''}}</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4 p-0">
                            <div>
                                <i
                                    class="las {{ $order->delivery_status == 2 ? 'la-check bg-blue text-white fs-8 rounded-3 p-1' : 'la-circle fs-20 text-blue' }} "></i>
                            </div>
                            <div class="d-flex flex-column ml-4">
                                <span>{{translate('Product Delivered')}}</span>
                                <span
                                    class="opacity-60">{{$order->delivery_time != null ? \Carbon\Carbon::parse($order->delivery_time)->format('H:i \h\r\s, j F, Y') : ''}}</span>
                            </div>
                        </div>
...
@endsection
    ...
    @section('modal')
                ...
                <div class="modal-content p-2rem">
                    <div class="modal-body text-center">
                        ...
                        <p class="mt-3 mb-3 fs-16 fw-700">
                            {{translate('Are you sure you want to change the payment status?')}}
                        </p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>{{ translate("Do you really want to " . ($order->user->banned == 1 ? 'Reinstate' : 'ban') . " this Customer?") }}
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light"
                            data-dismiss="modal">{{translate('Cancel')}}</button>
                        <a type="button" id="banConfirmation"
                            class="btn btn-primary">{{translate('Proceed!')}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="confirm-suspicious">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>{{ translate("Do you really want to " . ($order->user->banned == 1 ? 'unsuspect' : 'suspect') . " this Customer?") }}
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light"
                            data-dismiss="modal">{{translate('Cancel')}}</button>
                        <a type="button" id="suspiciousConfirmation"
                            class="btn btn-primary">{{translate('Proceed!')}}</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class=" mt-5">
                                <h6 class="separator mb-4 "><span
                                        class="bg-white pr-3">{{ translate('Account Information') }}</span>
                                </h6>
                                <p class="text-muted">
                                ...
                                <p class="text-muted"><strong>{{ translate('Registration Date') }}
                                        :</strong>
                                    <span class="ml-2">
                            ...
                            <div class=" mt-5">
                                ...
                                <p class="text-muted">
                                    ...
                                    <span
                                        class="ml-2">{{ format_price($order->user->preorders()->sum('subtotal')) }}</span>
                                </p>
                                <p class="text-muted">
                                    <strong>{{ translate('Number of orders in shipping') }} :</strong>
                                    <span
                                        class="ml-2">{{ $order->user->preorders()->where('shipping_status', 2)->where('delivery_status', 0)->count() }}</span>
                                </p>
                                <p class="text-muted">
                                    <strong>{{ translate('Number of items is delivered') }} :</strong>
                                    <span
                                        class="ml-2">{{ $order->user->preorders()->where('delivery_status', 2)->count() }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        @include('preorder.common.models.preorder_cormation')
    ...
    @section('script')
        <script type="text/javascript">
            ...
            function confirm_ban(url) {
                ...
                document.getElementById('banConfirmation').setAttribute('href', url);
            }
