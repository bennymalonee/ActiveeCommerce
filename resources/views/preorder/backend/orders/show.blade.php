                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="preorder-border-dashed rounded-2 d-flex justify-content-between p-4">
                            ...
                            <div class="px-4 mt-4 mb-2">
                                ...
                                @can('ban_customer')
                                    <a href="#">
                                        <span class="mt-2 badge  w-100  p-3 rounded-3 {{$order->user->banned == 1 ? "badge-danger text-white " : " badge-dodger-blue text-blue" }} " 
                                            onclick="confirm_ban('{{route('customers.ban', encrypt($order->user->id))}}');">
                                            {{ translate("" . ($order->user->banned == 1 ? 'Reinstate' : 'ban') . " this Customer?") }}
                                        </span>
                                    </a>
                                            ...
                                            <div class="row preorder-border-dashed p-4 m-4">
                                                ...
                                                <div class="col-12">
                                                    @if($order->prepayment_confirm_status == 1)
                                                        <div class="form-group ">
                                                            <label class="col-form-label"
                                                                for="signinSrEmail">{{translate('Note')}}<span class="ml-2">{{translate(('(Upto 200
                                                                    character)'))}}</span></label>
                            ...
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                    <path id="Path_42357" data-name="Path 42357"
                                        d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                        transform="translate(-48 -48)"
                                        fill="{{ preorder_fill_color($order->final_order_status) }}" />
                                </svg>
                                <span class="ml-2 fs-19 fw-700">{{ translate('Final Preorder') }}</span>
                            </div>
                            <p>
                            ...
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                    <path id="Path_42357" data-name="Path 42357"
                                        d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                        transform="translate(-48 -48)"
                                        fill="{{ preorder_fill_color($order->shipping_status) }}" />
                                </svg>
                                    ...
                                    <div class="row preorder-border-dashed p-4 m-4 d-flex ">
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if($order->shipping_note)
                                                <p class="border p-2" style="font-style: italic;"> {{ $order->shipping_note }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                    <path id="Path_42357" data-name="Path 42357"
                                        d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                        transform="translate(-48 -48)"
                                        fill="{{ preorder_fill_color($order->delivery_status) }}" />
                                </svg>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-12 px-4">
                                            ...
                                            @if($order->delivery_note)
                                                <p class="border p-2" style="font-style: italic;"> {{ $order->delivery_note }}
                                                </p>
                                            @endif
                                        </div>
                                        @if($order->product_owner == 'admin')
                            ...
                            <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingRefund" type="button"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle d-flex justify-content-center align-items-center"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="2" height="10" viewBox="0 0 2 10">
                                            <g id="Group_38901" data-name="Group 38901" transform="translate(-315 -540)">
                                                <rect id="Rectangle_23991" data-name="Rectangle 23991" width="2" height="7"
                                                    rx="1" transform="translate(315 540)" fill="#fff" />
                                                <rect id="Rectangle_23992" data-name="Rectangle 23992" width="2" height="2"
                                                    rx="1" transform="translate(315 548)" fill="#fff" />
                                            </g>
                                        </svg>
                                    ...
                                    @if($order->refund_status == 2)
                                        <span
                                            class="badge badge-inline badge-success m-2 p-2 rounded-3">{{ translate('Accepted')}}</span>
                                    @elseif($order->refund_status == 3)
                                        <span
                                            class="badge badge-inline badge-danger m-2 p-2 rounded-3">{{ translate('Rejected')}}</span>
                                    @endif
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" id="banConfirmation" class="btn btn-primary">{{translate('Proceed!')}}</a>
            </div>
        </div>
    </div>
</div>
