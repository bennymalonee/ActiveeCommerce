						...
						<div class="card-body">
							<form action="{{ route('business_settings.update') }}" method="POST"
								...
								<div class="form-group">
									...
									<small
										class="text-muted">{{ translate("Minimum dimensions required: 275px width X 44px height.") }}</small>
								</div>
								<!-- About description -->
								<div class="form-group">
	...
	<div class="card">
		...
		<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
			...
			<div class="card-body">
							...
							@if (get_setting('vendor_system_activation') == 1)
								<div class="form-group">
									...
									<div class="input-group form-group">
										...
										<<<<<<< HEAD <input type="text" class="form-control" placeholder="http://"
				...
				<<<<<<< HEAD <div class="card shadow-none bg-light">
					<div class="card-header">
						=======
						<div class="card shadow-none bg-light">
							<div class="card-header">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<div class="input-group" data-toggle="aizuploader" data-type="image"
										data-multiple="true">
										<div class="input-group-prepend">
											<<<<<<< HEAD <div class="input-group-text bg-soft-secondary font-weight-medium">
												{{ translate('Browse')}}
										</div>
									</div>
									<div class="form-control file-amount">{{ translate('Choose File') }}</div>
